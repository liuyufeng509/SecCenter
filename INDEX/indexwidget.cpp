...
//    ui->textBrowser_2->setCurrentFont(font);
    ...
    QString roleName = "";
    QString enforce = "";
    QString date = "2017-06-15";
    QString des = tr("\n    安全管理中心为安全操作系统的功能提供人机交互界面。包括系统管理员、安全管理员和审计管理员三个角色，分别提供不同的角色功能。分别提供功能如下：\n\
...
审计管理员管理功能包括审计信息查询、审计信息展示、审计策略配置和审计配置信息设置。详细信息请查看帮助。");
    ...
    系统管理员通过对系统的资源和运行进行配置、控制和管理，包括用户身份管理、系统资源配置、系统加载和启动、系统运行的异常处理等。系统管理员的管理功能包括用户管理、服务管理、系统日志查看和内核参数设置功能。详细信息请查看帮助。");
    QString audDec =tr("\n    安全管理中心为安全操作系统的功能提供人机交互界面。包括系统管理员、安全管理员和审计管理员三个角色，分别提供不同的角色功能。当前登陆的用户为审计管理员，审计管理员介绍如下：\n\
    审计管理员通过对分布在系统各个组成部分的安全审计机制集中管理，包括根据安全审计策略对审计记录进行分类；对各类审计记录进行存储、管理和查询等。对审计记录进行分析，并依据分析结果进行处理。\
审计管理员管理功能包括审计信息查询、审计信息展示、审计策略配置和审计配置信息设置。详细信息请查看帮助。");
//    curRole = ROOT;
    switch(curRole)
    {
